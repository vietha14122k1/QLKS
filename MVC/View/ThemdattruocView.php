...
<body>
    ...
    <form method="post" style="width: 85%; margin-left: 10px;" autocomplete="off"
          action="http://localhost/QLKS/Themdattruoc/themdattruoc">

        <div class="container">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h1 class="text-center">Vui lòng nhập thông tin để đặt trước</h1>
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <input required="true" type="text" class="form-control" name="sophong"
                           value="<?php if(isset($data["sophong"])) echo $data["sophong"];?>" readonly>
                    </div>
                    <div class="form-group">
                    ...
                    <button class="btn btn-success" name="btnLuu">Đặt trước</button>
